...
4. Invoke personas during review: "@Security-Agent, review this change"
...
- Add domain-specific personas to `PERSONAS.md` (e.g., @Performance-Agent, @Accessibility-Agent)
...
- [Part 2: Personas — How to Think With AI](articles/02_Part2_Personas.md)
- [Part 3: Skills — How to Encode What You Learn](articles/03_Part3_Skills.md)
- [Part 4: Worklogs — How AI Work Persists Over Time](articles/04_Part4_Worklogs.md)
